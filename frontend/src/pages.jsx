const ARTICLES = [
  {
    ...
    title: "How to make unlimited Gmail addresses from one Gmail",
    date: "September 18, 2026",
    excerpt: "Keep one Gmail. Generate a new address for every site. Paste App Password once and read OTP here.",
    steps: [
      ...
      "Enter your real Gmail and paste the App Password. Click Generate Gmail.",
      "Copy the new address (name+shop@gmail.com or na.me@gmail.com) and use it on the site. Do not give them your real Gmail.",
      "Click Generate another Gmail whenever you need a fresh address. All of them still belong to your one Gmail.",
      "OTP arrives in your real inbox and shows up here. Tap Copy code and paste it into the site.",
      "Your App Password is never saved in the browser. Remove an address any time. Discarding it only forgets the alias here — your real Gmail stays.",
    ],
    body: [
      "You are not creating a brand new Google account. Every extra address still belongs to your one Gmail. Mail sent to name+tag@gmail.com or na.me@gmail.com arrives in your normal inbox. FlickMail filters it so you only see OTP for the address you picked.",
